	...
	return (
		<div className="row">
			<div className="col">
				...
				<p>The sweet spot of meditation lies in a light-enough hold on one’s attention so as not to lose awareness of the present moment unfolding around you, but with enough attention so as not to lose touch with the object of meditation. It's OK if you find your mind wandering. Just return your attention to the object of meditation and continue as you were. Your mind will wander. It will wander less the more time you spend training it. It’s important to give yourself a break and allow your untrained mind space to grow. This wild, unpredictable mind is sometimes referred to as the <span className="bold">monkey mind</span>.</p>
